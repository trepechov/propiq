/**
 * Prompt injected into every neighborhood extraction/enrichment call.
 *
 * Tells Gemini how to interpret raw text about an area and map it to
 * the structured fields defined in src/types/neighborhood.ts. Edit freely —
 * this is plain text, not code.
 */

export const NEIGHBORHOOD_RESEARCH_CRITERIA = `
